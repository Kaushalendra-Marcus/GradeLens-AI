  ...
  return (
    <>
      <header className="h-[56px] bg-white border-b border-zinc-200 flex items-center px-4 lg:px-6 gap-3 shrink-0">
        <button onClick={() => setMobileOpen(true)} className="lg:hidden w-8 h-8 rounded-lg bg-zinc-900 text-white flex items-center justify-center hover:bg-zinc-800 active:scale-90 transition-all duration-200 hover:rotate-3">
